#ifndef _3X3MISERE_TIC_TAC_TOE_H
#define _3X3MISERE_TIC_TAC_TOE_H
...
public:
    Misere_Tic_Tac_Toe_Random_Player(string name,T symbol);
    void getmove(int& x, int& y);
};
...
// Constructor for Misere_Tic_Tac_Toe_Board
template <typename T>
...
// Constructor for Misere_Tic_Tac_Toe_Player
template <typename T>
...
// Constructor for Misere_Tic_Tac_Toe_Random_Player
template <typename T>
Misere_Tic_Tac_Toe_Random_Player<T>::Misere_Tic_Tac_Toe_Random_Player(string name,T symbol) : RandomPlayer<T>(symbol) {
    this->dimension = 3;
    this->name = name;
...
#endif //_3X3MISERE_TIC_TAC_TOE_H
